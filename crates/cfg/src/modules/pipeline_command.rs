    ...
    pub fn to_parameters(&self) -> Vec<ParameterDef> {
        match self {
            ...
            Self::ClassifyRois(_s) => vec![
                ...
                ParameterDef { name: "match_handling".to_string(), display_name: "Match Handling".to_string(), description: "What to do with object class labels after criteria evaluation\n\nControls whether the output class is added or existing classes are removed,\nand whether the action is triggered on a criteria **match** or a **non-match**:\n\n- **AddOutputClassIfMatch** - append the output class to objects that pass the criteria.\n- **AddOutputClassIfNotMatch** - append the output class to objects that fail the criteria.\n- **RemoveInputClassIfMatch / NotMatch** - strip all input classes from matching / non-matching objects.\n- **RemoveOutputClassIfMatch / NotMatch** - strip the output class from matching / non-matching objects.\n- **RemoveAllClassesIfMatch / NotMatch** - clear every class label from matching / non-matching objects.".to_string(), value: match _s.match_handling { ClassificationClassifyRoisClassifyMatchHandlingSettings::AddOutputClassIfMatch => "Add output class on match".to_string(), ClassificationClassifyRoisClassifyMatchHandlingSettings::AddOutputClassIfNotMatch => "Add output class on mismatch".to_string(), ClassificationClassifyRoisClassifyMatchHandlingSettings::RemoveInputClassIfMatch => "Remove input class on match".to_string(), ClassificationClassifyRoisClassifyMatchHandlingSettings::RemoveInputClassIfNotMatch => "Remove input class on mismatch".to_string(), ClassificationClassifyRoisClassifyMatchHandlingSettings::RemoveOutputClassIfMatch => "Remove output class on match".to_string(), ClassificationClassifyRoisClassifyMatchHandlingSettings::RemoveOutputClassIfNotMatch => "Remove output class on mismatch".to_string(), ClassificationClassifyRoisClassifyMatchHandlingSettings::RemoveAllClassesIfMatch => "Remove all classes on match".to_string(), ClassificationClassifyRoisClassifyMatchHandlingSettings::RemoveAllClassesIfNotMatch => "Remove all classes on mismatch".to_string(), ClassificationClassifyRoisClassifyMatchHandlingSettings::ReclassifyIfMatch => "Reclassify on match".to_string(), ClassificationClassifyRoisClassifyMatchHandlingSettings::ReclassifyIfNotMatch => "Reclassify on mismatch".to_string() }, param_type: ParamType::Dropdown, options: vec!["Add output class on match".to_string(), "Add output class on mismatch".to_string(), "Remove input class on match".to_string(), "Remove input class on mismatch".to_string(), "Remove output class on match".to_string(), "Remove output class on mismatch".to_string(), "Remove all classes on match".to_string(), "Remove all classes on mismatch".to_string(), "Reclassify on match".to_string(), "Reclassify on mismatch".to_string()], min: 0.0f32, max: 0.0f32, step: 1.0000f32, groups: vec![] },
        ...
        match self {
            ...
            Self::ClassifyRois(s) => {
                ...
                if param_name == "match_handling" {
                    s.match_handling = match value { "Add output class on match" => ClassificationClassifyRoisClassifyMatchHandlingSettings::AddOutputClassIfMatch, "Add output class on mismatch" => ClassificationClassifyRoisClassifyMatchHandlingSettings::AddOutputClassIfNotMatch, "Remove input class on match" => ClassificationClassifyRoisClassifyMatchHandlingSettings::RemoveInputClassIfMatch, "Remove input class on mismatch" => ClassificationClassifyRoisClassifyMatchHandlingSettings::RemoveInputClassIfNotMatch, "Remove output class on match" => ClassificationClassifyRoisClassifyMatchHandlingSettings::RemoveOutputClassIfMatch, "Remove output class on mismatch" => ClassificationClassifyRoisClassifyMatchHandlingSettings::RemoveOutputClassIfNotMatch, "Remove all classes on match" => ClassificationClassifyRoisClassifyMatchHandlingSettings::RemoveAllClassesIfMatch, "Remove all classes on mismatch" => ClassificationClassifyRoisClassifyMatchHandlingSettings::RemoveAllClassesIfNotMatch, "Reclassify on match" => ClassificationClassifyRoisClassifyMatchHandlingSettings::ReclassifyIfMatch, "Reclassify on mismatch" => ClassificationClassifyRoisClassifyMatchHandlingSettings::ReclassifyIfNotMatch, _ => s.match_handling.clone() };
                }
