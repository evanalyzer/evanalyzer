...
pub fn default_command(id: i32) -> Option<PipelineCommand> {
    match id {
        ...
        20 => Some(PipelineCommand::RoiMath(RoiMathSettings::default())),
        ...
        26 => Some(PipelineCommand::TransformRois(
...
impl PipelineCommand {
    ...
    pub fn category(&self) -> &CommandCategory {
        match self {
            ...
            Self::RoiMath(_) => &CommandCategory::Classify,
    ...
    pub fn to_parameters(&self) -> Vec<ParameterDef> {
        match self {
            ...
            Self::ConnectedComponents(_s) => vec![ParameterDef { name: "min_size_px".to_string(), display_name: "Min Size Px".to_string(), description: "Minimum object size, in pixels, an object must have to be kept.\n\nAfter labeling, connected components with a pixel count below this\nthreshold are discarded (their pixels are reset to background) and\nthe remaining object IDs are re-compacted to a contiguous range.\nUseful for suppressing noise/speckle artifacts before they reach\ndownstream measurement or classification steps. A value of 0 (the\ndefault) disables filtering.".to_string(), value: format!("{}", _s.min_size_px), param_type: ParamType::Spinner, options: vec![], min: 1.0f32, max: 0.0f32, step: 1.0000f32, groups: vec![] }],
            ...
            Self::TransformRois(_s) => [vec![ParameterDef { name: "function".to_string(), display_name: "Function".to_string(), description: "Geometric transform applied to each input ROI".to_string(), value: match _s.function { ClassificationTransformRoisTransformFunctionSettings::Scale { .. } => "Scale".to_string(), ClassificationTransformRoisTransformFunctionSettings::SnapArea { .. } => "Snap Area".to_string(), ClassificationTransformRoisTransformFunctionSettings::MinCircle { .. } => "Min Circle".to_string(), ClassificationTransformRoisTransformFunctionSettings::DrawCircle { .. } => "Draw Circle".to_string(), ClassificationTransformRoisTransformFunctionSettings::FittingEllipse { .. } => "Fitting Ellipse".to_string(), ClassificationTransformRoisTransformFunctionSettings::Expand { .. } => "Expand".to_string(), ClassificationTransformRoisTransformFunctionSettings::Shrink { .. } => "Shrink".to_string() }, param_type: ParamType::Dropdown, options: vec!["Scale".to_string(), "Snap Area".to_string(), "Min Circle".to_string(), "Draw Circle".to_string(), "Fitting Ellipse".to_string(), "Expand".to_string(), "Shrink".to_string()], min: 0.0f32, max: 0.0f32, step: 1.0000f32, groups: vec![] }], match &_s.function { ClassificationTransformRoisTransformFunctionSettings::Scale { factor } => vec![ParameterDef { name: "function.factor".to_string(), display_name: "Factor".to_string(), description: "Unitless scale factor".to_string(), value: format!("{}", factor), param_type: ParamType::Spinner, options: vec![], min: 0.0f32, max: 65535.0f32, step: 1.0000f32, groups: vec![] }], ClassificationTransformRoisTransformFunctionSettings::SnapArea { extra_size, unit } => vec![ParameterDef { name: "function.extra_size".to_string(), display_name: "Extra Size".to_string(), description: "Size added on top of the ROI's bounding-box diameter".to_string(), value: format!("{}", extra_size), param_type: ParamType::Spinner, options: vec![], min: 0.0f32, max: 65535.0f32, step: 1.0000f32, groups: vec![] }, ParameterDef { name: "function.unit".to_string(), display_name: "Unit".to_string(), description: "Unit `extra_size` is expressed in".to_string(), value: match unit { SizeUnits::NanoMeter => "nm".to_string(), SizeUnits::Pixels => "px".to_string() }, param_type: ParamType::SizeUnits, options: vec!["nm".to_string(), "px".to_string()], min: 0.0f32, max: 0.0f32, step: 1.0000f32, groups: vec![] }], ClassificationTransformRoisTransformFunctionSettings::MinCircle { min_diameter, unit } => vec![ParameterDef { name: "function.min_diameter".to_string(), display_name: "Min Diameter".to_string(), description: "Minimum circle diameter".to_string(), value: format!("{}", min_diameter), param_type: ParamType::Spinner, options: vec![], min: 0.0f32, max: 65535.0f32, step: 1.0000f32, groups: vec![] }, ParameterDef { name: "function.unit".to_string(), display_name: "Unit".to_string(), description: "Unit `min_diameter` is expressed in".to_string(), value: match unit { SizeUnits::NanoMeter => "nm".to_string(), SizeUnits::Pixels => "px".to_string() }, param_type: ParamType::SizeUnits, options: vec!["nm".to_string(), "px".to_string()], min: 0.0f32, max: 0.0f32, step: 1.0000f32, groups: vec![] }], ClassificationTransformRoisTransformFunctionSettings::DrawCircle { diameter, unit } => vec![ParameterDef { name: "function.diameter".to_string(), display_name: "Diameter".to_string(), description: "Circle diameter (0 = use the ROI's bounding box)".to_string(), value: format!("{}", diameter), param_type: ParamType::Spinner, options: vec![], min: 0.0f32, max: 65535.0f32, step: 1.0000f32, groups: vec![] }, ParameterDef { name: "function.unit".to_string(), display_name: "Unit".to_string(), description: "Unit `diameter` is expressed in".to_string(), value: match unit { SizeUnits::NanoMeter => "nm".to_string(), SizeUnits::Pixels => "px".to_string() }, param_type: ParamType::SizeUnits, options: vec!["nm".to_string(), "px".to_string()], min: 0.0f32, max: 0.0f32, step: 1.0000f32, groups: vec![] }], ClassificationTransformRoisTransformFunctionSettings::FittingEllipse { scale } => vec![ParameterDef { name: "function.scale".to_string(), display_name: "Scale".to_string(), description: "Unitless scale factor for the fitted ellipse".to_string(), value: format!("{}", scale), param_type: ParamType::Spinner, options: vec![], min: 0.0f32, max: 65535.0f32, step: 1.0000f32, groups: vec![] }], ClassificationTransformRoisTransformFunctionSettings::Expand { margin, unit } => vec![ParameterDef { name: "function.margin".to_string(), display_name: "Margin".to_string(), description: "Margin added on every side of the mask's contour".to_string(), value: format!("{}", margin), param_type: ParamType::Spinner, options: vec![], min: 0.0f32, max: 65535.0f32, step: 1.0000f32, groups: vec![] }, ParameterDef { name: "function.unit".to_string(), display_name: "Unit".to_string(), description: "Unit `margin` is expressed in".to_string(), value: match unit { SizeUnits::NanoMeter => "nm".to_string(), SizeUnits::Pixels => "px".to_string() }, param_type: ParamType::SizeUnits, options: vec!["nm".to_string(), "px".to_string()], min: 0.0f32, max: 0.0f32, step: 1.0000f32, groups: vec![] }], ClassificationTransformRoisTransformFunctionSettings::Shrink { margin, unit } => vec![ParameterDef { name: "function.margin".to_string(), display_name: "Margin".to_string(), description: "Margin removed from every side of the mask's contour".to_string(), value: format!("{}", margin), param_type: ParamType::Spinner, options: vec![], min: 0.0f32, max: 65535.0f32, step: 1.0000f32, groups: vec![] }, ParameterDef { name: "function.unit".to_string(), display_name: "Unit".to_string(), description: "Unit `margin` is expressed in".to_string(), value: match unit { SizeUnits::NanoMeter => "nm".to_string(), SizeUnits::Pixels => "px".to_string() }, param_type: ParamType::SizeUnits, options: vec!["nm".to_string(), "px".to_string()], min: 0.0f32, max: 0.0f32, step: 1.0000f32, groups: vec![] }] }, vec![ParameterDef { name: "input_class".to_string(), display_name: "Input Class".to_string(), description: "ROIs carrying this class are the input to the transform".to_string(), value: match _s.input_class.to_u32() { Some(v) => format!("{}", v), None => "-1".to_string() }, param_type: ParamType::ObjClass, options: vec![], min: 0.0f32, max: 0.0f32, step: 1.0000f32, groups: vec![] }], vec![ParameterDef { name: "output_class".to_string(), display_name: "Output Class".to_string(), description: "If unset, the transformed shape replaces the input ROI in place.\n\nIf set, a new ROI carrying this class is created for each transformed input ROI instead,\nleaving the input ROI untouched.".to_string(), value: match _s.output_class.to_u32() { Some(v) => format!("{}", v), None => "-1".to_string() }, param_type: ParamType::ObjClass, options: vec![], min: 0.0f32, max: 0.0f32, step: 1.0000f32, groups: vec![] }]].concat(),
    ...
    pub fn to_summary(&self) -> String {
        match self {
            ...
            Self::RoiMath(s) => format!("Operation: {}", match s.operation { ClassificationMathRoiRoiSetOperationSettings::And => "And".to_string(), ClassificationMathRoiRoiSetOperationSettings::Or => "Or".to_string(), ClassificationMathRoiRoiSetOperationSettings::Xor => "Xor".to_string(), ClassificationMathRoiRoiSetOperationSettings::Subtract => "Subtract".to_string() }),
            ...
            Self::TransformRois(s) => format!("Function: {}", match s.function { ClassificationTransformRoisTransformFunctionSettings::Scale { .. } => "Scale".to_string(), ClassificationTransformRoisTransformFunctionSettings::SnapArea { .. } => "Snap Area".to_string(), ClassificationTransformRoisTransformFunctionSettings::MinCircle { .. } => "Min Circle".to_string(), ClassificationTransformRoisTransformFunctionSettings::DrawCircle { .. } => "Draw Circle".to_string(), ClassificationTransformRoisTransformFunctionSettings::FittingEllipse { .. } => "Fitting Ellipse".to_string(), ClassificationTransformRoisTransformFunctionSettings::Expand { .. } => "Expand".to_string(), ClassificationTransformRoisTransformFunctionSettings::Shrink { .. } => "Shrink".to_string() }),
            ...
            Self::RoiMath(s) => {
                if param_name == "operation" {
                    s.operation = match value {
                        "And" => ClassificationMathRoiRoiSetOperationSettings::And,
                        "Or" => ClassificationMathRoiRoiSetOperationSettings::Or,
                        "Xor" => ClassificationMathRoiRoiSetOperationSettings::Xor,
                        "Subtract" => ClassificationMathRoiRoiSetOperationSettings::Subtract,
                        _ => s.operation.clone(),
                    };
                }
            ...
            Self::TransformRois(s) => {
                if param_name == "function" {
                    s.function = match value {
                        ...
                        "Expand" => ClassificationTransformRoisTransformFunctionSettings::Expand {
                            margin: 0.0f32,
                            unit: SizeUnits::NanoMeter,
                        },
                        "Shrink" => ClassificationTransformRoisTransformFunctionSettings::Shrink {
                            margin: 0.0f32,
                            unit: SizeUnits::NanoMeter,
                        },
                        _ => s.function.clone(),
                ...
                if let ClassificationTransformRoisTransformFunctionSettings::Scale {
                    ref mut factor,
                } = s.function
                {
                ...
                if let ClassificationTransformRoisTransformFunctionSettings::SnapArea {
                    ref mut extra_size,
                    ref mut unit,
                } = s.function
                {
                ...
                if let ClassificationTransformRoisTransformFunctionSettings::MinCircle {
                ...
                if let ClassificationTransformRoisTransformFunctionSettings::DrawCircle {
                    ref mut diameter,
                    ref mut unit,
                } = s.function
                {
                ...
                if let ClassificationTransformRoisTransformFunctionSettings::FittingEllipse {
                    ref mut scale,
                } = s.function
                {
                ...
                if let ClassificationTransformRoisTransformFunctionSettings::Expand {
                    ref mut margin,
                    ref mut unit,
                } = s.function
                {
                ...
                if let ClassificationTransformRoisTransformFunctionSettings::Shrink {
                    ref mut margin,
                    ref mut unit,
                } = s.function
                {
